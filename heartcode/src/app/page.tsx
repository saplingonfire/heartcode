...
export default function Home() {
  ...
  return (
    <div className="flex flex-col mx-auto items-center justify-center bg-gray-50 p-4">
      ...
      <Card className="border-black border-8 m-8 w-1/2 h-fit mt-2.5 bg-[url('https://img.freepik.com/free-photo/colorful-abstract-textured-background-design_53876-108265.jpg')]">
    ...
    <CardHeader>
      ...
      <CardDescription>My name is Zhi Ying and I'm a Sec 3 student this year.</CardDescription>
    </CardHeader>
    <CardContent>
        ...
        <div className="grid w-full items-center gap-4">
          ...
          <CardDescription>I like to listen to music and play games</CardDescription>
          <Carousel className="w-60 h-60 mx-auto">
            <CarouselContent>
          ...
          <CardDescription>I have two older brothers</CardDescription>
          </div>
        </div>
    </CardContent>
