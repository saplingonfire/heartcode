...
export default function AboutMe() {
  ...
  return (
    <div className="flex flex-col mx-auto items-center justify-center bg-gray-50 p-4">
      ...
      <Card className="border-black border-4 m-8 w-1/2 h-fit mt-2.5 bg-[url('https://img.freepik.com/free-photo/colorful-abstract-textured-background-design_53876-108265.jpg')] bg-cover">
        ...
        <div className="grid w-full items-center gap-4">
          ...
          <Carousel className="w-72 h-72 mx-auto">
            <CarouselContent>
              ...
              <CarouselItem> <a href="https://www.youtube.com/@CoComelon"> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRJ4RspB5joRhIphHkADINw_xDEknhOjZs5CMEC0ZS0mzlc6UmUvpEtFu_qgdD2Q266RMk&usqp=CAU" className="rounded-[24px] h-full" alt=""/> </a> </CarouselItem>
            </CarouselContent>
           <CarouselPrevious />
           <CarouselNext />
          </Carousel>
